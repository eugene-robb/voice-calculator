...
public class VoiceTTS extends Thread {
	 ...
	 */
	public VoiceTTS(File audioFile) throws IOException, UnsupportedAudioFileException {
	 ...
	 * @param ais
	 */
	public VoiceTTS(AudioInputStream ais) {
		this.ais = ais;
	}
	 ...
	 * @throws UnsupportedAudioFileException
	 */
	public VoiceTTS(File audioFile, LineListener lineListener) throws IOException, UnsupportedAudioFileException {
		this.ais = AudioSystem.getAudioInputStream(audioFile);
	 ...
	 * @param lineListener
	 */
	public VoiceTTS(AudioInputStream ais, LineListener lineListener) {
		this.ais = ais;
		this.lineListener = lineListener;
	}
	 ...
	 * @throws UnsupportedAudioFileException
	 */
	public VoiceTTS(File audioFile, SourceDataLine line, LineListener lineListener)
	 ...
	 * @param lineListener
	 */
	public VoiceTTS(AudioInputStream ais, SourceDataLine line, LineListener lineListener) {
		this.ais = ais;
		this.line = line;
		this.lineListener = lineListener;
	}
	 ...
	 */
	public VoiceTTS(File audioFile, SourceDataLine line, LineListener lineListener, int outputMode)
			throws IOException, UnsupportedAudioFileException {
		this.ais = AudioSystem.getAudioInputStream(audioFile);
		this.line = line;
		this.lineListener = lineListener;
	 ...
	 *            output channel.
	 */
	public VoiceTTS(AudioInputStream ais, SourceDataLine line, LineListener lineListener, int outputMode) {
		this.ais = ais;
		this.line = line;
		this.lineListener = lineListener;
		this.outputMode = outputMode;
